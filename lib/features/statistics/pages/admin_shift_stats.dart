...
class AdminShiftStats extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    // Watch the providers for different time periods
    final dailyHoursWorked = ref.watch(ProviderUtils.hoursWorkedProvider('day'));
    final weeklyHoursWorked = ref.watch(ProviderUtils.hoursWorkedProvider('week'));
    final monthlyHoursWorked = ref.watch(ProviderUtils.hoursWorkedProvider('month'));
    final yearlyHoursWorked = ref.watch(ProviderUtils.hoursWorkedProvider('year'));
